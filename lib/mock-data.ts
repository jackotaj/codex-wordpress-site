...
export const customers: Customer[] = [
  {
    ...
    events: [
      { id: "e1", type: "APPOINTMENT_CREATED", title: "Appointment scheduled", detail: "Saturday, August 29 at 1:00 PM · Palisade test drive", channel: "CRM", timestamp: "9:15 AM" },
      { id: "e2", type: "CUSTOMER_REPLIED", title: "John replied", detail: "Saturday at 1 works. Can I test drive the Calligraphy?", channel: "SMS", timestamp: "9:11 AM" },
      { id: "e3", type: "AI_TEXT_SENT", title: "Sarah sent a text", detail: "Absolutely. Would Saturday morning or afternoon work better for a quick test drive?", channel: "SMS", timestamp: "9:08 AM" },
      { id: "e4", type: "CUSTOMER_REPLIED", title: "John replied", detail: "Still interested in the Palisade. What would payments look like?", channel: "SMS", timestamp: "9:07 AM" },
      { id: "e5", type: "LEAD_CREATED", title: "New internet lead received", detail: "2026 Hyundai Palisade Calligraphy · Hyundai.com", channel: "CRM", timestamp: "9:02 AM" }
    ]
  },
